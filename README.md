...
- **Standard 6 (Verifiable Signs Only):** NEVER invent a sign. ** the `Context` MUST contain the exact explicit keyword (e.g., "important," "exam," "mcq") from the transcript given by the user.
#### MCQs
